...
@ProviderFor(emojis)
final emojisProvider = EmojisProvider._();
...
final class EmojisProvider
  ...
  @override
  String debugGetCreateSourceHash() => _$emojisHash();
...
String _$emojisHash() => r'62ea41dd7e589799afadd5fe5f56fbb0d587c0b4';

@ProviderFor(emojisByCategory)
final emojisByCategoryProvider = EmojisByCategoryProvider._();

final class EmojisByCategoryProvider
    extends
        $FunctionalProvider<
          AsyncValue<Map<String, List<EmojiModel>>>,
          Map<String, List<EmojiModel>>,
          FutureOr<Map<String, List<EmojiModel>>>
        >
    with
        $FutureModifier<Map<String, List<EmojiModel>>>,
        $FutureProvider<Map<String, List<EmojiModel>>> {
  EmojisByCategoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'emojisByCategoryProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$emojisByCategoryHash();

  @$internal
  @override
  $FutureProviderElement<Map<String, List<EmojiModel>>> $createElement(
    $ProviderPointer pointer,
  ) => $FutureProviderElement(pointer);

  @override
  FutureOr<Map<String, List<EmojiModel>>> create(Ref ref) {
    return emojisByCategory(ref);
  }
}

String _$emojisByCategoryHash() => r'1f19be1677ab8a7baa1b404cf82706227489ca81';
